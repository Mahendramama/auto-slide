...
<h1 className="text-3xl font-semibold text-slate-800">Odia News Slide Generator</h1>
<p className="text-slate-600 mt-2">Paste one or more news URLs (newline or comma separated). For each link, we fetch the article, summarize in ~30 words, translate to Odia, and render a 1280×720 slide with the image.</p>
</header>
